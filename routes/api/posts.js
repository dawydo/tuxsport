...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      //Get user name, avatar and user itself
...
router.delete('/:id', [auth, checkObjectId], async (req, res) => {
  try {
    ...
    // Check if user post match with user id
...
router.delete('/comment/:id/:comment_id', auth, async (req, res) => {
    try {
        ...
        // Check if user created this comment and can delete it
